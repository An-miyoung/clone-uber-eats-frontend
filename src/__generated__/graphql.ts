...
export const PotatoMutationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "PotatoMutation" },
      variableDefinitions: [
        {
...
export type AllCategorieOutput = {
...
export type Query = {
  __typename?: "Query";
  allCategories: AllCategorieOutput;
...
export type QueryRetaurantsArgs = {
...
export type PotatoMutationMutation = {
  __typename?: "Mutation";
  login: {
    __typename?: "LoginOutput";
    ok: boolean;
